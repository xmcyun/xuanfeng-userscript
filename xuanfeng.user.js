    ...
    requestDownloadLinks(function (dls) {
        ...
        if (config.url) {
            ...
            .fail(function () {
                ...
                g_pop_rpc.showConfig(config.url)
            })
        } else {
        ...
        <div class="com_win_cont">
            <div class="pop">
                <div class="con">
                    ...
                    <p class="ex_rpc_tip">使用<code>aria2c --enable-rpc=true --rpc-allow-origin-all=true --rpc-user=test --prc-passwd=123</code></p>
                </div>
            </div>
        </div>
    </div>
...
var pop = window.g_pop_aria = new xfDialog('ex_rpc_config')
